  ...
  function cozenTooltip(Themes) {
    ...
    function link(scope, element, attrs) {
      ...
      function init() {
        ...
        scope._cozenTooltipLabel      = attrs.cozenTooltipLabel;
        scope._cozenTooltipPlacement  = angular.isDefined(attrs.cozenTooltipPlacement) ? attrs.cozenTooltipPlacement : 'auto right';
        scope._cozenTooltipBody       = angular.isDefined(attrs.cozenTooltipBody) ? attrs.cozenTooltipBody : true;
        scope._cozenTooltipCloseDelay = angular.isDefined(attrs.cozenTooltipCloseDelay) ? attrs.cozenTooltipCloseDelay : 100;
        scope._cozenTooltipDelay      = angular.isDefined(attrs.cozenTooltipDelay) ? attrs.cozenTooltipDelay : 250;
