...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            fr: {
                src : '<%= yeoman.app %>/directives/**/*.fr.json',
                dest: '<%= yeoman.app %>/languages/fr.concat.json'
            },
            en: {
                src : '<%= yeoman.app %>/directives/**/*.en.json',
                dest: '<%= yeoman.app %>/languages/en.concat.json'
            }
        },
    ...
    grunt.registerTask('languages', 'Languages task to compile the .json', function () {
        var targets = [];
        appConfig.languages.forEach(function (lang) {
            targets.push('concat:' + lang);
        });
